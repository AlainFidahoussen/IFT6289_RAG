"""LLM-as-judge: score generated answers with qwen3.5:35b via Ollama."""
...
from answer_generation.dataset import get_answer_field, load_data_vidore
...
def main(
    ...
    """Judge generated answers with qwen3.5:35b and compute pass@1.

    Reads generated answers from data/processed/answers/<condition>/.
    Saves per-query judgments to data/processed/judgments/<condition>/.
